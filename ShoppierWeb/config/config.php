...
define('DB_NAME', 'jonnykle_shoppier');
define('DB_USER', 'jonnykle_admin');
define('DB_PASS', 'p6As?YfvzJG');
...
define("EMAIL_PASSWORDRESET_FROM_EMAIL", "noreply@jonnyklemmer.com");
define("EMAIL_PASSWORDRESET_FROM_NAME", "Shoppier");
define("EMAIL_PASSWORDRESET_SUBJECT", "Password reset for Shoppier");
define("EMAIL_PASSWORDRESET_CONTENT", "Please click on this link to reset your password: ");

define("EMAIL_VERIFICATION_URL", URL . "login/verify");
define("EMAIL_VERIFICATION_FROM_EMAIL", "noreply@jonnyklemmer.com");
define("EMAIL_VERIFICATION_FROM_NAME", "Shoppier");
define("EMAIL_VERIFICATION_SUBJECT", "Account Activation for Shoppier");
define("EMAIL_VERIFICATION_CONTENT", "Please click on this link to activate your account: ");
